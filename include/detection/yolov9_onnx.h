 ...
 * @Date         : 2024-05-11 21:02:33
 * @LastEditors  : Rainer-seventeen
 * @LastEditTime : 2024-05-11 21:23:42
 */
/*
 * @Author       : Rainer-seventeen 1652018592@qq.com
...
{
public:
	Yolov9Onnx() : _OrtMemoryInfo(Ort::MemoryInfo::CreateCpu(OrtAllocatorType::OrtDeviceAllocator, OrtMemType::OrtMemTypeCPUOutput)){};
	~Yolov9Onnx()
	{
...
private:
	...
	// ONNXRUNTIME
	Ort::Env _OrtEnv = Ort::Env(OrtLoggingLevel::ORT_LOGGING_LEVEL_ERROR, "Yolov9");
